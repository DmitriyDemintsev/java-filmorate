...
public class UserControllerTest {
    ...
    void checkGetUsers() throws UserAlreadyExistException {
        ...
        User user1 = new User(1, "test@test_1.com", "try_test_1", "Jim Beam", birthday1);
        User user2 = new User(2, "test@test_2.com", "try_test_2", "John Donne", birthday2);
    ...
    void checkCreateUser() throws UserAlreadyExistException {
        ...
        User user1 = new User(1, "test@test_1.com", "try_test_1", "Jim Beam", birthday1);
        User user2 = new User(2, "test@test_2.com", "try_test_2", null, birthday1);
        User user3 = new User(3, null, "try_test_3", "Jim Beam", birthday1);
        User user4 = new User(4, "testtest_4.com", "try_test_4", "Jim Beam", birthday1);
        User user5 = new User(5, "test@test_5.com", null, "Jim Beam", birthday1);
        User user6 = new User(6, "test@test_6.com", "try test_6", "Jim Beam", birthday1);
        User user7 = new User(7, "test@test_7.com", "try_test_7", "Jim Beam", birthday2);
        User user8 = new User(8, "test@test_1.com", "try_test_8", "Jim NickName", birthday3);
    ...
    void checkPutUser() throws UserAlreadyExistException {
        ...
        User user = new User(1, "test@test.com", "oldLogin", "Jim Beam", birthday1);
